    ...
    <div class="page-wrap">        
	    <div class="masthead">
            ...
            <div class="text" style="text-indent: 0px">
                <p>UserBallot is a new one-touch feedback gathering tool based around yes or no questions that lets website owners get real time answers from more customers than ever before. All <span class="best">you</span> do is copy and paste a few lines of code into your website!</p>
